module.exports = {
  ...
  VNP_RETURN_URL: process.env.VNP_RETURN_URL || 'https://0122f7433d0d.ngrok-free.app/api/payments/vnpay-return',

  // IPN URL cho server-to-server callback
  VNP_IPN_URL: process.env.VNP_IPN_URL || 'https://0122f7433d0d.ngrok-free.app/api/payments/vnpay-ipn',
  
  // Callback URL cho xử lý callback (tương thích với backend api)
  VNP_CALLBACK_URL: process.env.VNP_CALLBACK_URL || 'https://0122f7433d0d.ngrok-free.app/api/payments/handle-callback',
